// noise.js - Sistema de ruído Perlin
export function createNoiseFunction(rng) {
...
export function getLayeredNoise(noise, x, z, octaves, persistence, scale) {
...
export function getCaveDensity(noise, x, y, z) {
    return noise(x * 0.08, y * 0.12, z * 0.08);
}
