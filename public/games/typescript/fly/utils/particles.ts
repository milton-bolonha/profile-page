...
export const updateEngineParticles = (engineParticles: THREE.Points | null, isTurbo: boolean) => {
...
export const spawnConfetti = (pos: THREE.Vector3, count: number, confettiParticles: ConfettiParticle[], scene: THREE.Scene) => {
...
export const updateConfetti = (confettiParticles: ConfettiParticle[], scene: THREE.Scene) => {
