  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 xs:px-5 sm:px-6 md:px-8 text-center relative z-10">
        ...
        <div className="mt-8 sm:mt-10 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5 md:gap-6 text-gray-700 dark:text-white">
            ...
            if (contact.type === 'email' && contact.translationKey) {
              return (
                <a
                  ...
                  className="flex items-center gap-2 hover:text-blue-200 transition-colors text-sm sm:text-base"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  </svg>
                  <span className="font-medium truncate">{t(contact.translationKey)}</span>
                </a>
              );
