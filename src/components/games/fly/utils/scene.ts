...
export const initSpaceLevel = (
  ...
  console.log("FLY GAME: spaceGroup added to scene");
  ...
  console.log("FLY GAME: Stars added, count:", starCount);
  ...
  console.log("FLY GAME: Tunnel segments created:", tunnelSegments.length);
