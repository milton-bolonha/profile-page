...
export const FloatingContactButton = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100]" style={{ position: 'fixed' }}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 bg-black/90 backdrop-blur-md rounded-2xl border border-white/20 p-6 w-80"
          >
            <div className="flex flex-col gap-4">
              <Link
                href="/contato"
                className="bg-white text-black hover:bg-white/90 font-medium px-6 py-3 text-sm rounded-full transition-all text-center"
              >
              ...
              <div className="flex items-center gap-3 justify-center pt-2">
                <a
                  ...
                  className="p-3 rounded-full border border-white/20 hover:border-white/40 transition-all"
                  title="WhatsApp"
                >
