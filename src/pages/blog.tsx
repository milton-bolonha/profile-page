...
// Componente auxiliar para usar o hook do Clerk com segurança - só no cliente
...
const BlogContent = ({ businessSettings, generalSettings }: BlogProps) => {
  ...
  if (hasClerkKey && !authState.isLoaded) {
    return (
      <BlogAuthWrapper onAuthStateChange={handleAuthStateChange}>
        {(state) => (
          <div className="min-h-screen flex items-center justify-center">
            <div className="text-center">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
              <p className="text-gray-600 dark:text-gray-300">
                {t("blog.exclusive.loading")}
              </p>
            </div>
          </div>
        )}
  ...
  const showContent = authState.isSignedIn || !hasClerkKey;
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          property="og:title"
          content={`Blog | ${businessSettings.brandName}`}
        />
        <meta
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="relative">
                ...
                <div className="space-y-12">
                  {Array.isArray(t("blog.timeline")) &&
                    t("blog.timeline").map((item: any, index: number) => (
